...
/**
 * This class implements the Frame that provide to insert new item in the main table.
 * Contains the listener for the button apply, that implements the saving on file.
 * 
 * 
